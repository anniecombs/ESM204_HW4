...
ggplot(data = cost_compare) +
  geom_line(aes(x = cost/1e12, y = cost_a/1e12)) + 
  geom_line(aes(x = cost/1e12, y = cost_b/1e12)) +
  theme_minimal() + 
...
Judging from our rendered plot and knowing that society in this scenario is risk neutral, Congress should use Policy B if it costs less than $2000 trillion to implement. At any price above that, Congress should use Policy A.

## 6. Now suppose that society is risk averse. How do you think this would change your advice to Congress?

Congress would only want to consider using Policy B if we consider that the society is risk averse.
