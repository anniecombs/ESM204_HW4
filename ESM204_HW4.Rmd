...
# find the new SCC
scc %>%
  mutate(dr0.021 = scc_not_discounted/(1.021^years_into_future))

scc0.021 <- sum(scc$dr0.021)

# update SCC table
scc_vector <- c(scc0.021, scc0.025, scc0.5, scc0.75, scc1, scc1.5, scc2, scc3, scc4, scc5, scc6)
dr <- c(0.021, 0.25, 0.5, 0.75, 1, 1.5, 2, 3, 4, 5, 6)
scc_table <- data.frame(scc_vector, dr)
