...
#create a new variable for warming2
warming2 <- model_damages$warming2 <- model_damages$warming^2

#fit quadratic regression model
quadraticModel_damages <- lm(damages ~ warming + warming2, data= damages)

#view model summary
summary(quadraticModel_damages)
